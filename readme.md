...
<link rel="shortcut icon" type="x-icon" href="icon.png">
    <body style="background-color: rgb(255, 245, 238);">
        <img align="center" src="https://media.tenor.com/images/0f7b59e27e63edbf1f097820e234a1fe/tenor.gif?ctx=share" alt="hello">
      <h1 align="center">Hello Guys!!!!</h1>  
      <h5 align="center">About me 
     </h5>
     <ol>
     <li><h4>Name: Pritam Santra</h4></li>
     <li><h4>Age: 12+ years</h4></li>
    ...
    <p align="center"> <a href ="https://pritam2958.github.io/WEBS/">See my Projects</a></p>
    </details>
     </i></h2>
     <hr/>
  ...
  <ul>
  <li><p><b>Fav Movie makers:</b> MCU (Marvel Cinematic Universe) </li>
  <br /></p>
  <li><p><b>Fav Superhero:</b> Dr.Strange,Deadpool and Iron Man <br /></p></li>
  <li><p><b>Fav Ice Cream Flavour:</b> Choco </li>
  <br /></p>
  <li><p><b>Fav TV show:</b> Cricket Matches <br /></p></li>
  <li><p><b>Fav youtuber:</b> Triggered Insaan </li>
<br /></p>
  <li><p><b>Fav music band:</b> Imagine Dragons (the singers of <i>"believer"</i>) and League of Legends (singers of <i>"Legends Never Die"</i>) </li>
  </p>
  <li><p> <b> fav singer: </b> Alan Walker </p></li>
  <li><p> <b>biggest fear:</b> bees ~_~ !! </p></li>
  <li><p><b>fav food:</b> As an Indian , I like <i>Mutton Biriani</i></p></li>
  <li><p><b>fav programming language:</b> C++</p></li>
  <li><p><b>fav job:</b> Web Developer</p> </li>
  </ul>
  <hr /> 
